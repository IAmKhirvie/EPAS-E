...
class UpdateModuleRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'qualification_title.required' => 'The subject or program is required.',
            'qualification_title.max'      => 'The subject or program must not exceed 255 characters.',
            'unit_of_competency.required'  => 'The learning focus is required.',
            'unit_of_competency.max'       => 'The learning focus must not exceed 255 characters.',
