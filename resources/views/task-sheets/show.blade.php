...
<div class="content-area">
    <nav aria-label="breadcrumb" class="mb-2">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('courses.modules.show', [$taskSheet->informationSheet->module->course_id, $taskSheet->informationSheet->module]) }}">{{ $taskSheet->informationSheet->module->module_name }}</a></li>
