                ...
                <div class="card-body">
                    <form action="{{ route('topics.update', [$informationSheet->id, $topic->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-5">
                            ...
                            <div id="noPartsMessage" class="text-center py-4 bg-light rounded border-dashed" @if($topic->parts && count($topic->parts) > 0) style="display: none;" @endif>
    ...
    window.previewPartImage = function(input) {
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                // Keep the hidden input for existing image reference
