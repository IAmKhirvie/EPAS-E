...
<body class="auth-page-body">
    ...
    <div class="content-container">
        <div class="page-header">
            ...
            <p class="lead">Get in touch with IETI Marikina or submit an inquiry</p>
        </div>
            ...
            <div class="col-12">
                <div class="contact-map-container">
                    <div class="map-header mb-3">
                        <h4><i class="fas fa-map-marked-alt me-2"></i>IETI Marikina Campus Location</h4>
                        <p class="text-muted">34 Lark Street, Sta. Elena, Marikina City</p>
                    </div>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d925.7822268843197!2d121.09956074646428!3d14.634067983489432!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397b835490659d5%3A0x6574ba3f78ebdd32!2sIETI%20College%20of%20Science%20and%20Technology%2C%20Marikina%2C%20Inc.!5e0!3m2!1sen!2sph!4v1769575366881!5m2!1sen!2sph" width="100%" height="400" style="border:0; border-radius: 8px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>

        <!-- Contact Methods & Inquiry Form -->
        <div class="row mb-5">
            <!-- Contact Information -->
            <div class="col-lg-5 mb-4">
                <div class="contact-card h-100">
                    ...
                    <h4 class="mb-4">IETI College Marikina</h4>
            ...
            <div class="col-lg-7 mb-4">
                <div class="contact-card h-100">
                    ...
                    <h4 class="mb-4">Send Us an Inquiry</h4>
        ...
        <div class="row">
            <div class="col-12">
                <div class="contact-info bg-light p-4 rounded">
                    <h4 class="mb-4"><i class="fas fa-building me-2"></i>Other IETI Campus</h4>
                    <div class="row">
                        <div class="col-md-6">
