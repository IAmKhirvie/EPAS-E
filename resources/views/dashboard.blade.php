...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const filterType = document.getElementById('feed-filter-type');
    ...
    function filterAndSort() {
        ...
        let visibleCount = 0;
        const items = Array.from(feedItems);
        ...
        // Reorder in DOM
        visibleItems.forEach(item => activityFeed.appendChild(item));
    ...
    document.querySelectorAll('.pending-sort').forEach(btn => {
        btn.addEventListener('click', function(e) {
            ...
            const items = Array.from(list.querySelectorAll('.pending-item'));
