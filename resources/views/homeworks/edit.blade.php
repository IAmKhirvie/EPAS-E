        ...
        <div class="cb-builder-layout">
            ...
            <div class="cb-main">
                <div class="cb-header cb-header--homework">
                    ...
                    <p>{{ $homework->homework_number }} &mdash; {{ $informationSheet->title }}</p>
                </div>
                ...
                <div class="cb-body">
                    ...
                    <div class="cb-settings">
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control @error('homework_number') is-invalid @enderror" name="homework_number" value="{{ old('homework_number', $homework->homework_number) }}" required>
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title', $homework->title) }}" required>
                                @error('title')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-2 mb-3">
                                <label class="cb-field-label">Max Points <span class="required">*</span></label>
                                <input type="number" class="form-control @error('max_points') is-invalid @enderror" name="max_points" value="{{ old('max_points', $homework->max_points) }}" min="1" required>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="datetime-local" class="form-control @error('due_date') is-invalid @enderror" name="due_date" value="{{ old('due_date', $homework->due_date->format('Y-m-d\TH:i')) }}" required>
                                @error('due_date')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="cb-field-label">Description <span class="optional">(optional)</span></label>
                                <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="2">{{ old('description', $homework->description) }}</textarea>
                                @error('description')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="cb-field-label">Instructions <span class="required">*</span></label>
                                <textarea class="form-control @error('instructions') is-invalid @enderror" name="instructions" rows="2" required>{{ old('instructions', $homework->instructions) }}</textarea>
                    ...
                    <div class="cb-detail-row">
                        <div class="cb-detail-col">
                            ...
                            <div id="requirements-container">
                                ...
                                <div class="cb-list-item">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="requirements[]" value="{{ $requirement }}" required>
                        ...
                        <div class="cb-detail-col">
                            ...
                            <div id="guidelines-container">
                                ...
                                <div class="cb-list-item">
                                    <i class="fas fa-grip-vertical cb-list-item__handle"></i>
                                    <input type="text" class="form-control form-control-sm" name="submission_guidelines[]" value="{{ $guideline }}" required>
                                    <button type="button" class="cb-list-item__remove" onclick="DynamicForm.removeListItem(this)"><i class="fas fa-times"></i></button>
                                </div>
                                @endforeach
                            </div>
                    ...
                    <div class="cb-section">
                        ...
                        <div class="mb-2 d-flex flex-wrap gap-2">
                            ...
                            <img src="{{ Storage::url($image) }}" alt="Reference" class="img-thumbnail" style="max-height: 80px;">
                            @endforeach
                        </div>
                        @endif
                        <label class="cb-upload-area">
                            ...
                            <div class="cb-upload-area__text">
                                ...
                                <small>Upload to replace existing images</small>
                            </div>
